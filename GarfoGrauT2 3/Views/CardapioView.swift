...
//                .background(.green)
        ...
        VStack{
            List{
                ...
                Produto(nome: "SORVETE", descricao: "Baunilha, chocolate e morango", preco: "49,90", imagem: "Produto2", disponivel: true)
                Produto(nome: "SOPA", descricao: "Sopinha de miojo com salsicha", preco: "89,90", imagem: "Produto3", disponivel: true)
